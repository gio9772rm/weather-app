...
(() => {
  ...
  function bindRadar(){
    ...
    // OSM requires the genuine site Referer. Origin identifies this app without
    // exposing station selections, private URLs or query parameters.
    $("#radar-base").innerHTML=`<img alt="" referrerpolicy="origin" src="https://tile.openstreetmap.org/${z}/${tx}/${ty}.png" style="left:0;top:0;width:100%;height:100%">`;
  ...
  window.MeteoExtra={
    ...
    bind:p=>{restoreDrafts();switch(p){
      case "maps": return bindRadar();
      case "cities": return bindCities();
      case "planner": return bindPlanner();
      case "journal": return bindJournal();
      case "inbox": return bindInbox();
      case "activities": return bindActivities();
      default: return undefined;
    }},
